      ...
      <div className="flex-1 lg:w-3/5 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="flex gap-2 mb-6 bg-gray-100 rounded-lg p-1">
            <Link
              href="/auth/signup"
              className={`flex-1 py-2 px-4 rounded-md font-semibold transition-colors text-center ${activeTab === 'signup'
            ...
            <button
              ...
              className={`flex-1 py-2 px-4 rounded-md font-semibold transition-colors ${activeTab === 'login'
                ? 'bg-white text-gray-900 shadow-sm'
                : 'text-gray-600 hover:text-gray-900'
                }`}
            >
